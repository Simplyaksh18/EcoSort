  ...
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm ring-1 ring-gray-200">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold">Alerts (≥80%)</h3>
        <Pill
          label={`${alerts.length}`}
      ...
      <div className="mt-4 space-y-3">
        {alerts.map((a) => {
          const autoEnabled =
            (a.type === "Organic" || a.type === "Hazardous") && a.fill >= 80;
          const enabled =
            autoEnabled ||
            a.fill >= 90 ||
            (a.fill >= 80 && a.type === "Recyclable");
          return (
            <div
              key={a.id}
